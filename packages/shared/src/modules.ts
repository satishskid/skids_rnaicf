...
export const MODULE_CONFIGS: ModuleConfig[] = [
  ...
  { type: 'hearing', name: 'Hearing Screening', description: 'Pure-tone audiometry via earphones', icon: 'Headphones', duration: '5-7 min', captureType: 'form', recommendedAge: ['preschool', 'school', 'adolescent'], color: 'bg-indigo-600', group: 'head_to_toe' },
