...
export const FOUR_D_CONDITIONS: FourDCondition[] = [
  ...
  { id: 'defc12', name: 'Poor Dietary Diversity', category: 'deficiency', icdCode: 'E63.1', description: 'Inadequate variety in food groups consumed, increasing risk of multiple micronutrient deficiencies.', chipIds: ['ni8', 'ni10', 'ni_in_h8', 'ni_in_h9', 'ni_in_h10', 'ni_ae_h5', 'ni_ae_h6', 'ni_df_h6', 'ni_df_h7'], sourceModules: ['nutrition_intake'] },
