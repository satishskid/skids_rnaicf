/**
 * Motor assessment — tremor detection and stability analysis.
 * Analyzes position tracking data from video or accelerometer.
 */
 ...
 * @param positions - Array of tracked positions with timestamps
 */
export function analyzeMotorPerformance(
  ...
  // Tremor = frequency of velocity direction reversals
  let tremor = 0
