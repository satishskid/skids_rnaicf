...
const MODULE_TYPE = 'eyes_external'
const CAMERA_FACING = 'user' as const

export function EyesExternalScreening({
      ...
      <Card>
        ...
        <CardContent className="space-y-4">
          <div className="relative aspect-[4/3] bg-gray-900 rounded-lg overflow-hidden">
            ...
            <MediaPipeOverlay videoRef={videoRef} tasks={['face']} />
            <div className="absolute bottom-4 left-0 right-0 text-center text-white text-sm bg-black/30 py-1">
              Close-up of both eyes — ask {childName} to look straight ahead
            </div>
          </div>
